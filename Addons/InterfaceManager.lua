...
local InterfaceManager = {} do
    ...
    function InterfaceManager:BuildInterfaceSection(tab)
        ...
        -- [[ INJEKSI TEMA CYBERPUNK DARI GITHUB ]]
        ...
        if success and CyberpunkTheme then
            ...
            -- Memaksa Accent Color segera berubah (Cyberpunk Vibe)
            Library.AccentColor = CyberpunkTheme.AccentColor or Color3.fromRGB(0, 255, 255)
        else
            warn("❌ Gagal memuat tema Cyberpunk, menggunakan Dark.")
        ...
        section:AddParagraph({
            ...
            Content = "Tema eksklusif RHDXP Hub (Neon Style) telah diterapkan."
        })
    
        if Library.UseAcrylic then
            section:AddToggle("AcrylicToggle", {
                Title = "Acrylic (Blur)",
                Description = "Membutuhkan kualitas grafik 8+",
        ...
        section:AddToggle("TransparentToggle", {
            Title = "Transparency",
            Description = "Membuat UI menjadi tembus pandang.",
        ...
        -- Sinkronisasi tombol minimize dengan Library
        Library.MinimizeKeybind = MenuKeybind
    end
end

return InterfaceManager -- SANGAT PENTING: Agar tidak Nil saat di-load
